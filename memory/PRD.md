...
- Accounts CRUD with auto-computed `current_balance = opening + incomes − expenses`
- Categories CRUD (expense / income kinds, colors)
- Transactions CRUD with name, date, unit_price, quantity, billed_amount, category, account, is_recurrent + recurrence_period (weekly/monthly/yearly), notes
